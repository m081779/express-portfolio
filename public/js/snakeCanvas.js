...
let playerX = 20; //initial player x coordinate
let playerY = 20; //initial player y coordinate
let gridSize = 20; //size of grid squares
let tileCount = 30; //number of tiles in grid
...
function initialize() {
  ...
  ctx.fillText("Start Game", snakeCanvas.width/2, snakeCanvas.height/2);
...
function game() {
  ...
  for (let i = 0; i < snakePositions.length; i++){
    ...
    ctx.fillRect(snakePositions[i].x * gridSize, snakePositions[i].y * gridSize, gridSize-2, gridSize-2);
